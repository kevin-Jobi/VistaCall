...
// import 'package:vistacall/presentation/widgets/home/health_care_articles.dart';
...
//     return Scaffold(
//       appBar: const HomeAppBar(),
//       body: _buildBody(context, viewModel, homeBloc),
//       // floatingActionButton: _buildFloatingActionButton(context),
//       bottomNavigationBar: CustomBottomNavBar(
//         currentIndex: 0,
//         onTap: (index) => _handleNavigation(index, context),
...
//   Widget _buildBody(
//       BuildContext context, HomeViewModel viewModel, HomeBloc homeBloc) {
...
//                     itemBuilder: (context, index) {
//                       final doctor = viewModel.getFilteredDoctors()[index];
//                       print('Rendering doctor: ${doctor.personal['fullName']}');
//                       return _buildModernDoctorCard(context, doctor);
//                     },
//                   )
//                 ],
...
// // lib/presentation/views/home.dart
// import 'package:flutter/material.dart';
// import 'package:flutter_bloc/flutter_bloc.dart';
// import 'package:provider/provider.dart';
...
// import 'package:vistacall/presentation/widgets/custom_bottom_navbar.dart';
// import 'package:vistacall/presentation/widgets/home/doctor_categories_grid.dart';
// import 'package:vistacall/presentation/widgets/home/doctor_card.dart';
// import 'package:vistacall/presentation/widgets/home/health_care_articles.dart';
// import 'package:vistacall/presentation/widgets/home/home_app_bar.dart';
// import 'package:vistacall/presentation/widgets/home/search_section.dart';
// import 'package:vistacall/viewmodels/home_viewmodel.dart';
...
//                 return _buildContent(context, viewModel, homeState, doctorState);
//               },
//             );
//           },
//         );
...
//     // Loading state
//     if (viewModel.isHomeLoading(homeState) || viewModel.isDoctorListLoading(doctorState)) {
//       return const Center(child: CircularProgressIndicator());
//     }
...
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
//           SearchSection(onSearchChanged: viewModel.setSearchQuery),
//           const SizedBox(height: 20),
//           DoctorCategoriesGrid(
//             categories: categoriesToShow,
//             onCategoryTap: (category) => 
//                 viewModel.navigateToDepartment(context, category.title),
//           ),
          
//           // Search results
//           if (viewModel.hasSearchResults) ...[
//             const SizedBox(height: 24),
//             _buildSearchResultsHeader(viewModel.searchResultCount),
//             const SizedBox(height: 12),
//             _buildDoctorsList(context, viewModel),
//           ],
...
//   Widget _buildDoctorsList(BuildContext context, HomeViewModel viewModel) {
...
//             context,
//             '/drprofile',
//             arguments: {'doctor': doctor, 'doctorId': doctor.id},
//           ),
//         );
//       },
//     );
