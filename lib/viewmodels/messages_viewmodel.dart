...
class MessagesViewModel {
  ...
  String? getError(MessagesState state) =>
      state is MessagesErrorState ? state.error : null;
  ...
  void handleConversationTap(BuildContext context, Conversation conversation) {
    print(
        'Navigating to ChatDetailScreen - DoctorID: ${conversation.doctorId}, DoctorName: ${conversation.doctorName}');
    Navigator.pushNamed(
      context,
