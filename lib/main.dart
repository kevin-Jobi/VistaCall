...
//                 doctorListBloc: BlocProvider.of<DoctorListBloc>(context))),
...
//         BlocProvider(
//             create: (context) =>
//                 DoctorListBloc(firestore: FirebaseFirestore.instance)),
//         BlocProvider(create: (context) => PasswordVisibilityBloc()),
//       ],
//       child: ChangeNotifierProvider(
//         create: (context) {
//           final homeBloc = BlocProvider.of<HomeBloc>(context, listen: false);
//           final doctorListBloc =
//               BlocProvider.of<DoctorListBloc>(context, listen: false);
//           print(
//               'Creating HomeViewModel with homeBloc: $homeBloc, doctorListBloc: $doctorListBloc');
//           return HomeViewModel(homeBloc, doctorListBloc);
//         },
//         child: MaterialApp(
